...
public class AssessmentTracker extends Frame implements ActionListener, WindowListener, KeyListener
{
    ...
    // private String[] topLine = {"QNS", "Q1", "Q2", "Q3", "Q4", "Q5", "Q6", "Q7", "Q8", "Q9", "Q10","Result"};
//private String[] timeLine = {"Answers","Jane", "Tony", "Ahmed", "Alisha", "Peta", "Jenny", "Hong", "James", "Teri", "Henri", "Cian","Han","Lou",};
